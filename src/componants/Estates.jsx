...
const Estates = ({ data }) => {
    ...
    return (
        <div  className="" data-aos="zoom-in-left">
            <div className="hd shadow-2xl w-full border-2 border-yellow-200 h-min lg:w-[375px]  lg:pl-0 1 rounded-2xl mt-4 lg:mt-0">
                <div className="card card-compact flex items-center  bg-base-100 text-center  shadow-xl h-[550px] ">
                    ...
                    <div className="card-body  w-full ">
                        <div className="h-[80px]">
                            <p data-aos="slide-down" className="text-2xl font-semibold w-[300px] md:w-full md:text-center lg:text-start  hv text-start ml-4   ">{estate_title}</p>
